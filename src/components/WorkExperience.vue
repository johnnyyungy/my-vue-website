...
export default {
  ...
  data() {
    return {
      showJobs: false, // Controls visibility of additional jobs
    };
  },
  methods: {
    toggleJobs() {
      this.showJobs = !this.showJobs; // Toggle visibility
    },
  },
};
</script>
